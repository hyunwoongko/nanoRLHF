...
| Implementation                                                                    | Description                       | References                                                                                                         | Textbook                                                                         | Examples                                                                       |
|-----------------------------------------------------------------------------------|-----------------------------------|--------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
| [`nanosets`](https://github.com/hyunwoongko/nanorlhf/tree/main/nanorlhf/nanosets) | zero-copy dataset library         | [arrow](https://github.com/apache/arrow), [datasets](https://github.com/huggingface/datasets)                      | [Done](https://github.com/hyunwoongko/nanoRLHF/tree/main/nanorlhf/nanosets/docs) | [Done](https://github.com/hyunwoongko/nanorlhf/tree/main/examples/nanosets.py) |
| [`nanoray`](https://github.com/hyunwoongko/nanorlhf/tree/main/nanorlhf/nanoray)   | distributed computing engine      | [ray](https://github.com/ray-project/ray)                                                                          | In progress                                                                      | [Done](https://github.com/hyunwoongko/nanorlhf/tree/main/examples/nanoray.py)  |
| [`nanotron`](https://github.com/hyunwoongko/nanorlhf/tree/main/nanorlhf/nanotron) | model and data parallelism engine | [Megatron-LM](https://github.com/NVIDIA/Megatron-LM), [oslo](https://github.com/EleutherAI/oslo)                   | Not started                                                                      | [Done](https://github.com/hyunwoongko/nanorlhf/tree/main/examples/nanotron.py) |
| [`kernels`](https://github.com/hyunwoongko/nanorlhf/tree/main/nanorlhf/kernels)   | various triton kernels            | [flash-attention](https://github.com/Dao-AILab/flash-attention/), [trident](https://github.com/kakaobrain/trident) | Not started                                                                      | [Done](https://github.com/hyunwoongko/nanorlhf/tree/main/examples/kernels.py)  |
| [`nanovllm`](https://github.com/hyunwoongko/nanorlhf/tree/main/nanorlhf/nanovllm) | high performance inference engine | [vllm](https://github.com/vllm-project/vllm), [nano-vllm](https://github.com/GeeeekExplorer/nano-vllm)             | Not started                                                                      | [Done](https://github.com/hyunwoongko/nanorlhf/tree/main/examples/nanovllm.py) |
| [`nanoverl`](https://github.com/hyunwoongko/nanorlhf/tree/main/nanorlhf/nanoverl) | RLHF training framework           | [verl](https://github.com/volcengine/verl), [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF),                      | Not started                                                                      | [Done](https://github.com/hyunwoongko/nanoRLHF/tree/main/scripts)              |

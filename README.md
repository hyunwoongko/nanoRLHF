...
| Implementation                                                                  | Description                       | Textbook                                                                         | Example                                                                        | References                                                                                                         |
|---------------------------------------------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------|--------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
| [nanosets](https://github.com/hyunwoongko/nanorlhf/tree/main/nanorlhf/nanosets) | zero-copy dataset library         | [Done](https://github.com/hyunwoongko/nanoRLHF/tree/main/nanorlhf/nanosets/docs) | [Done](https://github.com/hyunwoongko/nanorlhf/tree/main/examples/nanosets.py) | [arrow](https://github.com/apache/arrow), [datasets](https://github.com/huggingface/datasets)                      |
| [nanoray](https://github.com/hyunwoongko/nanorlhf/tree/main/nanorlhf/nanoray)   | distributed computing engine      | In progress                                                                      | [Done](https://github.com/hyunwoongko/nanorlhf/tree/main/examples/nanoray.py)  | [ray](https://github.com/ray-project/ray)                                                                          |
| [nanotron](https://github.com/hyunwoongko/nanorlhf/tree/main/nanorlhf/nanotron) | model and data parallelism engine | Not started                                                                      | [Done](https://github.com/hyunwoongko/nanorlhf/tree/main/examples/nanotron.py) | [Megatron-LM](https://github.com/NVIDIA/Megatron-LM), [oslo](https://github.com/EleutherAI/oslo)                   |
| [kernels](https://github.com/hyunwoongko/nanorlhf/tree/main/nanorlhf/kernels)   | various triton kernels            | Not started                                                                      | [Done](https://github.com/hyunwoongko/nanorlhf/tree/main/examples/kernels.py)  | [flash-attention](https://github.com/Dao-AILab/flash-attention/), [trident](https://github.com/kakaobrain/trident) |
| [nanovllm](https://github.com/hyunwoongko/nanorlhf/tree/main/nanorlhf/nanovllm) | high performance inference engine | Not started                                                                      | [Done](https://github.com/hyunwoongko/nanorlhf/tree/main/examples/nanovllm.py) | [vllm](https://github.com/vllm-project/vllm), [nano-vllm](https://github.com/GeeeekExplorer/nano-vllm)             |
| [nanoverl](https://github.com/hyunwoongko/nanorlhf/tree/main/nanorlhf/nanoverl) | RLHF training framework           | Not started                                                                      | [Done](https://github.com/hyunwoongko/nanoRLHF/tree/main/scripts)              | [verl](https://github.com/volcengine/verl), [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF),                      |
